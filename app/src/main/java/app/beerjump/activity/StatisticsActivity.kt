...
class StatisticsActivity : AbstractActivity() {
    ...
    fun loadLocalStatistics() {
        ...
        stats.add(KeyValuePair(getString(R.string.disappearing_bars), Config.stats.cntDisappearingBar.toString()))
        stats.add(KeyValuePair(getString(R.string.teleporting_bars), Config.stats.cntTeleportingBar.toString()))
        stats.add(KeyValuePair("", ""))
        ...
        val req = JsonObjectRequest(
            ...
            null,
            {
                if (it.getInt("statusCode") == 200) {
                    ...
                    stats.add(KeyValuePair(getString(R.string.app_started), obj.getInt("starts").toString()))
                    stats.add(KeyValuePair(getString(R.string.games_played), obj.getInt("plays").toString()))
                    stats.add(KeyValuePair("", ""))
                    stats.add(KeyValuePair(getString(R.string.default_bars_jumped_on), obj.getInt("cnt_bar").toString()))
                    stats.add(KeyValuePair(getString(R.string.horizontal_moving_bars), obj.getInt("cnt_moving_x_bar").toString()))
                    stats.add(KeyValuePair(getString(R.string.vertical_moving_bars), obj.getInt("cnt_moving_y_bar").toString()))
                    stats.add(KeyValuePair(getString(R.string.disappearing_bars), obj.getInt("cnt_disappearing_bar").toString()))
                    stats.add(KeyValuePair(getString(R.string.teleporting_bars), obj.getInt("cnt_teleporting_bar").toString()))
                    stats.add(KeyValuePair("", ""))
                    stats.add(KeyValuePair(getString(R.string.beers_drunk), obj.getInt("cnt_beer").toString()))
                    stats.add(KeyValuePair(getString(R.string.shots_drunk), obj.getInt("cnt_shot").toString()))
                    stats.add(KeyValuePair(getString(R.string.rockets_used), obj.getInt("cnt_rocket").toString()))
                    stats.add(KeyValuePair("", ""))
                    ...
                    if (type == "average") {
                        ...
                        stats.add(KeyValuePair("", ""))
                        stats.add(KeyValuePair(getString(R.string.highest_score), obj.getInt("high_score").toString()))
                        stats.add(KeyValuePair(getString(R.string.last_score), obj.getInt("last_score").toString()))
                        stats.add(KeyValuePair("", ""))
                    ...
                    stats.add(KeyValuePair("", ""))
                    stats.add(KeyValuePair(getString(R.string.falls), obj.getInt("falls").toString()))
                    stats.add(KeyValuePair(getString(R.string.cancelled_games), obj.getInt("quits").toString()))
                    adapter.statistics = stats
                    adapter.notifyDataSetChanged()
