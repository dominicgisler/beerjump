...
object Config {
    ...
    fun init(sharedPref: SharedPreferences, context: Context) {
        ...
        stats.cntDisappearingBar = sharedPref.getInt("cnt_disappearing_bar", 0)
        stats.cntTeleportingBar = sharedPref.getInt("cnt_teleporting_bar", 0)
    ...
    fun save() {
        with (sharedPref.edit()) {
            ...
            putInt("cnt_disappearing_bar", stats.cntDisappearingBar)
            putInt("cnt_teleporting_bar", stats.cntTeleportingBar)
    ...
    fun syncDevice() {
        ...
        try {
            ...
            jsonObject.put("cnt_disappearing_bar", stats.cntDisappearingBar)
            jsonObject.put("cnt_teleporting_bar", stats.cntTeleportingBar)
